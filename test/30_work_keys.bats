...
@test "Work keys: translation case" {
  ...
  # translated work, key based on translated title (long version)
  ...
  # translated work, key based on translated title (short version)
  grep -q -F '<http://purl.org/dc/terms/identifier> "im universum zu hause/valtaoja, esko/uhlmann, peter"' slices/kotona-00097-work-keys.nt
...
@test "Work keys: corporate author case" {
  ...
  # short version generated only from main title (245a)
  grep -q -F '<http://purl.org/dc/terms/identifier> "suomen ekumeeninen neuvosto/suomen ekumeeninen neuvosto"' slices/ekumeeninen-00585-work-keys.nt
  # long version generated from variant title (246)
...
@test "Work keys: no main author case" {
  ...
  # short versions (245a)
  grep -q -F '<http://purl.org/dc/terms/identifier> "viemäreiden sisäpuoliset saneerausmenetelmät/muoviteollisuus (yhdistys)"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "viemäreiden sisäpuoliset saneerausmenetelmät/suomen standardisoimisliitto"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "viemäreiden sisäpuoliset saneerausmenetelmät/kaunisto, tuija"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "viemäreiden sisäpuoliset saneerausmenetelmät/pelto-huikko, aino"' slices/part-uri-00683-work-keys.nt
  # long versions (246)
  ...
  # long versions in other languages (246)
  grep -q -F '<http://purl.org/dc/terms/identifier> "renovation of drains and sewers with nodig methods/muoviteollisuus (yhdistys)"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "renovation of drains and sewers with nodig methods/suomen standardisoimisliitto"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "renovation of drains and sewers with nodig methods/kaunisto, tuija"' slices/part-uri-00683-work-keys.nt
  grep -q -F '<http://purl.org/dc/terms/identifier> "renovation of drains and sewers with nodig methods/pelto-huikko, aino"' slices/part-uri-00683-work-keys.nt
